/**
 * Per-page /api/<slug>/index.md — clean markdown alternate for every
 * indexable entry of the `api` collection. Mirrors the primary .md
 * alternate at src/pages/[...slug]/index.md.ts.
 */
