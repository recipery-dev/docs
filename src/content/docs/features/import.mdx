...
so it's handled differently: Recipery pulls the title, channel name, and
thumbnail from YouTube's oEmbed endpoint and attaches the video to the
recipe (see [Video](/features/library#video)) — that part always works.
